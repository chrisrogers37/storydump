-- Migration: 051_chain_reconciliation.sql
...
SELECT window_ddl.fn_051_chain_reconciliation();

INSERT INTO schema_version (version, description, applied_at)
VALUES (51, 'Chain reconciliation: drop 004/008 orphaned unique; caption_style to TEXT (#712)', NOW())
