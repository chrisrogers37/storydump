...
class BackfillDownloader:
    ...
    async def fetch_media_page(
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                f"{settings.meta_ig_graph_base}/{ig_account_id}/media",
                params=params,
    ...
    async def fetch_stories(
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                f"{settings.meta_ig_graph_base}/{ig_account_id}/stories",
                params=params,
                timeout=self.service.API_TIMEOUT,
            )
    ...
    async def fetch_carousel_children(
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                f"{settings.meta_ig_graph_base}/{carousel_id}/children",
                params=params,
                timeout=self.service.API_TIMEOUT,
            )
