> **Archived 2026-09-02 — STALE backlog.** Marked ready since 2026-03 with no code, issue or PR since; targets the legacy Telegram `/status` command. Revive by filing an issue. See [`documentation/archive/README.md`](../README.md) for the index.
