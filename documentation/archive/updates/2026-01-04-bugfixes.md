> **Archived 2026-09-18 — HISTORY of the legacy tier.** The bugs, files and line numbers here belong to the legacy scheduler and Telegram bot, deleted in the legacy tear-out (#1216, September 2026). Kept as the record of what was fixed and why. See [`documentation/archive/README.md`](../README.md) for the index.
