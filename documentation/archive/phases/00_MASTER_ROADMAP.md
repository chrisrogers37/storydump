> **Archived 2026-09-02 — SUPERSEDED.** Phases 1–2.5 are accurate history; the e-commerce-hub vision and phases 3–8 are not the current program (FC-9 of the consolidated plan: a hosted Instagram Story scheduling service). The forward plan is `documentation/planning/2026-08-02-consolidated-design-plan/`. See [`documentation/archive/README.md`](../README.md) for the index.
