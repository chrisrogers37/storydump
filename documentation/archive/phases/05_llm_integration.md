> **Archived 2026-09-02 — SUPERSEDED.** Only the caption slice shipped, as `src/services/core/caption_service.py` (#182); the provider abstraction, templates and email drafting were never built. See [`documentation/archive/README.md`](../README.md) for the index.
