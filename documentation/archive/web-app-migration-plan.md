> **Archived 2026-09-02 — EXECUTED (Apr 2026), then SUPERSEDED.** Its three phases merged as PRs #196/#201/#202; the Telegram-Login + BFF-JWT design was replaced by the target tier's Google sign-in and API (#1015, #1028, #1032). See [`documentation/archive/README.md`](README.md) for the index.
