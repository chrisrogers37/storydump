> **Archived 2026-09-02 — COMPLETED as legacy, then SUPERSEDED.** Migrations 035–041 landed the identity/credential split (#468 closed 2026-06-04; the parent #380 is still open); the target tier rebuilds it as `ig_accounts` / `oauth_credentials`. See [`documentation/archive/README.md`](README.md) for the index.
