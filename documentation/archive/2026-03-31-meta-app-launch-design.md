> **Archived 2026-09-02 — COMPLETED as legacy, then SUPERSEDED.** The Instagram-Login OAuth path it designed shipped in the legacy tier; FC-4 of the consolidated plan rules the Facebook-Login path out and the target-side rebuild is `src/services/target/ig_login_oauth.py` (#863). App Review itself is tracked at #410 and `documentation/operations/meta-app-review.md`. See [`documentation/archive/README.md`](README.md) for the index.
