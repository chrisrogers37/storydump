...
|---|---|---|
| 2026-07 full-system review (91 findings, 5 epics) | `documentation/archive/2026-07-system-review/triage-tracker.md`, `documentation/archive/2026-07-system-review/detailed-findings.md` | Confirmed and extended; epics #576–#579, #560 adopted as umbrellas |
...
| Credential refactor (staged additive→dual-write→cutover) | `documentation/archive/2026-05-18-instagram-credential-refactor.md`; M-035–M-041 | The in-repo template for every stage in [06-migration-and-consumer-plan.md](06-migration-and-consumer-plan.md) |
| Session-isolation planning vs shipped ContextVar design | `documentation/archive/per-request-session-isolation.md`, `src/repositories/base_repository.py` | Background for the UoW work (#608, #630) |
| Web app migration plan / instance picker | `documentation/archive/web-app-migration-plan.md`, `planning/multi-account-dashboard.md` | Motivates workspace-first identity (C7) |
