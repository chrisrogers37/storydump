...
- **Run report per attempt** *(none was ever filed here; the rehearsal and the window are recorded in `../2026-09-16-legacy-tear-out/RUN_LOG.md`)*: `runs/<date>-<leg>-<n>.md` (tracked files, never comments): branch identity block (§2.1 values), per-step wall-clock table, gate outcomes, §3 checklist results, anomalies verbatim.
