> **Archived 2026-09-02 — COMPLETED by a different mechanism.** `concurrent_updates(8)` plus per-task ContextVar sessions shipped in PR #573 (#557); the async unit of work it wanted is the target tier's `unit_of_work.py` (L.0). See [`documentation/archive/README.md`](README.md) for the index.
