> **Archived 2026-09-02 — BUILT, not activated.** The redirect page shipped as `docs/index.html` (PR #116) and its button wiring was later removed; activation is tracked at #528. See [`documentation/archive/README.md`](README.md) for the index.
