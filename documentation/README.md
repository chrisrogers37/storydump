...
- **[2026-09-07-category-registry-and-full-walk/](planning/2026-09-07-category-registry-and-full-walk/00_EPIC.md)** — Category registry keyed by Drive folder id + full-depth walk (supersedes the name-keyed categories of #1251) — DRAFT, ironclad cycle 1 folded; all forks locked (F4 re-locked after review); four PRs: lazy walk, registry, weights by id + automatic, web card
