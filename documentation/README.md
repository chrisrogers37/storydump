...
- **[2026-09-07-category-registry-and-full-walk/](planning/2026-09-07-category-registry-and-full-walk/00_EPIC.md)** — Category registry keyed by Drive folder id + full-depth walk (supersedes the name-keyed categories of #1251) — DRAFT, all seven forks locked by the owner 2026-09-07; three phases: registry + walk, weights by id + auto, web card
