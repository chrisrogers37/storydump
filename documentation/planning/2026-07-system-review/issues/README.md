...
documentation/planning/2026-07-system-review/issues/file-issues.sh

# Actually create the issues:
documentation/planning/2026-07-system-review/issues/file-issues.sh --confirm

# Optional: target a specific repo (defaults to the current repo):
documentation/planning/2026-07-system-review/issues/file-issues.sh --confirm --repo chrisrogers37/storydump
```
